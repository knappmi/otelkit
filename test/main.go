...
func main() {
	// Configure OTelKit to test logs with OTLP exporter
	config := otelkit.Config{
		ServiceName: "test-logs",
		ServiceVersion: "1.0.0",
		Environment: "development",
		ExporterType: otelkit.ExporterOTLP, // Use OTLP for traces
		OTLPEndpoint: "localhost:4318",
		EnableLogs: true,
		LogsExporterType: otelkit.ExporterOTLP, // Use OTLP to test collector
		Debug: true,
